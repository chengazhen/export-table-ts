var exportData = (() => {
        ...
        var f =
          ...
          g =
            ...
            (typeof window != 'object' || window !== f
              ...
              ? function (f2, g2, h) {
                  if (
                    ((g2 = g2 || f2.name || 'download'), typeof f2 != 'string')
                  )
              ...
              : function (b2, d2, e2, g2) {
                  if (
                    ...
                    return c(b2, d2, e2)
                  var h = b2.type === 'application/octet-stream',
                  ...
                  if (
                    ...
                    ;(k.onloadend = function () {
                      ...
                      ;(a2 = j
                        ? a2
                        : a2.replace(/^data:[^;]*;/, 'data:attachment/file;')),
      ...
      (epoch -
        (SSFdnthresh +
          /* @__PURE__ */ (v.getTimezoneOffset() -
            /* @__PURE__ */ SSFbasedate.getTimezoneOffset()) *
            6e4)) /
      (24 * 60 * 60 * 1e3)
    )
  }
  ...
  var good_pd_date = /* @__PURE__ */ isNaN(
    /* @__PURE__ */ good_pd_date_1.getFullYear()
  )
  ...
  var utf8read =
    (has_buf &&
      /* @__PURE__ */ ((utf8readc(utf8corpus) ==
        /* @__PURE__ */ utf8reada(utf8corpus) &&
        utf8readc) ||
        /* @__PURE__ */ (utf8readb(utf8corpus) ==
          /* @__PURE__ */ utf8reada(utf8corpus) &&
          utf8readb))) ||
    utf8reada
  ...
  function write_Hyperlink(hl) {
    ...
    if (F == 28) {
      ...
      out.write_shift(2, 0)
      if (F & 8)
        write_HyperlinkString(
          hashidx > -1 ? Target.slice(hashidx + 1) : '',
          out
        )
    } else {
        ...
        for (j = 0; j < headers.length; ++j) {
          ...
          switch (coltypes[j]) {
            case 'L':
              rout.write_shift(
                1,
                data[i][j] == null ? 63 : data[i][j] ? 84 : 70
              )
              break
            case 'B':
  ...
  var ExprotExcel = class {
    ...
    exportData(tableData, tableHeader, sheetName = 'table') {
      ...
      ;(0, import_file_saver.saveAs)(blob, sheetName + '.xlsx')
    }
    s2ab(s) {
    ...
    aoa_to_sheet(datas, headerRows) {
      ...
      datas.forEach((data, R) => {
        data.forEach((item, C) => {
          ...
          const cell = {
            v: item || '',
            s: Object.assign({}, this.defaultCellStyle)
          }
          if (R < headerRows) {
  ...
  var exportExcel = new ExprotExcel()
  var exportData = exportExcel.exportData.bind(exportExcel)
  var src_default = ExprotExcel
  return exportData
})()
